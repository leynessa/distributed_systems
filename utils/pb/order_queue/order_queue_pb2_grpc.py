...
class OrderQueueServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetQueueStatus = channel.unary_unary(
                '/orderqueue.OrderQueueService/GetQueueStatus',
                request_serializer=order__queue__pb2.QueueStatusRequest.SerializeToString,
                response_deserializer=order__queue__pb2.QueueStatusResponse.FromString,
                )
...
def add_OrderQueueServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetQueueStatus': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=order__queue__pb2.QueueStatusRequest.FromString,
                    response_serializer=order__queue__pb2.QueueStatusResponse.SerializeToString,
            ),
    }
...
class OrderQueueService(object):
    ...
    def GetQueueStatus(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/orderqueue.OrderQueueService/GetQueueStatus',
            order__queue__pb2.QueueStatusRequest.SerializeToString,
            order__queue__pb2.QueueStatusResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
