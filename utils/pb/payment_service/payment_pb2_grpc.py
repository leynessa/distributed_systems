...
class PaymentServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Prepare = channel.unary_unary(
                '/paymentservice.PaymentService/Prepare',
        ...
        self.Commit = channel.unary_unary(
                '/paymentservice.PaymentService/Commit',
        ...
        self.Abort = channel.unary_unary(
                '/paymentservice.PaymentService/Abort',
...
def add_PaymentServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'paymentservice.PaymentService', rpc_method_handlers)
...
class PaymentService(object):
    ...
    def Prepare(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/paymentservice.PaymentService/Prepare',
    ...
    def Commit(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/paymentservice.PaymentService/Commit',
    ...
    def Abort(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/paymentservice.PaymentService/Abort',
