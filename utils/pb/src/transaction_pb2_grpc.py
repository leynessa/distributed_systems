...
class TransactionVerifierStub(object):
    ...
    def __init__(self, channel):
        ...
        self.VerifyTransaction = channel.unary_unary(
                '/transaction.TransactionVerifier/VerifyTransaction',
...
class TransactionVerifierServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_TransactionVerifierServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'transaction.TransactionVerifier', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('transaction.TransactionVerifier', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class TransactionVerifier(object):
    """Missing associated documentation comment in .proto file."""
